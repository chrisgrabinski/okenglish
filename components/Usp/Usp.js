export default function Usp({ title, description }) {
  return (
    <div className="grid place-items-center gap-4">
      <div className="grid place-items-center w-12 h-12 bg-secondary-200 rounded-2xl">
        <svg
          className="h-6 fill-current text-primary-900"
          viewBox="0 0 576 512"
        >
      ...
      <p>
        ...
        <span className="block opacity-75">{description}</span>
      </p>
    </div>
  );
}
